...
def send(pHTML, pText):
    ...
    subject, from_email, to_email, message_html, message_text = sanitize_email_content('NetWatch Report', get_setting_value("SMTP_REPORT_FROM"), get_setting_value("SMTP_REPORT_TO"), pHTML, pText)
